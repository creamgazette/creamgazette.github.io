  ...
  var AudioPlayer = (function () {
    ...
    function renderPL() {
      ...
      playList.forEach(function (item, i) {
        html.push(tplList.replace("{count}", i).replace("{title}", item.title));
      });

      pl = create("div", {
        className: "pl-container animated 1s",
        id: "pl",
        innerHTML:
          '<ul class="pl-ul">' +
          (!isEmptyList()
    ...
    function plToggle() {
      ...
      if (plBtn.classList.contains("is-active")) {
        pl.classList.contains("fadeOut")
          ? pl.classList.replace("fadeOut", "fadeIn")
          : pl.classList.add("fadeIn");
        pl.classList.toggle("h-show");
      } else {
        pl.classList.replace("fadeIn", "fadeOut");
        setTimeout(() => {
          pl.classList.toggle("h-show");
        }, 1000);
      }
