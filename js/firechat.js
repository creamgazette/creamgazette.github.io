(function () {
  ...
  (n.reduce = n.foldl = n.inject = function (a, b, c, d) {
    ...
    (n.contains = n.include = function (a, b) {
      return (
        null != a &&
        (a.length !== +a.length && (a = n.values(a)), n.indexOf(a, b) >= 0)
      );
    }),
    ...
    (n.shuffle = function (a) {
      for (
        var b,
          c = a && a.length === +a.length ? a : n.values(a),
          d = c.length,
          e = Array(d),
          f = 0;
        d > f;
    ...
    (n.sample = function (a, b, c) {
      return null == b || c
        ? (a.length !== +a.length && (a = n.values(a)),
          a[n.random(a.length - 1)])
        : n.shuffle(a).slice(0, Math.max(0, b));
    }),
  ...
  (n.groupBy = q(function (a, b, c) {
    ...
    (n.last = function (a, b, c) {
      return null == a
        ...
        : null == b || c
        ? a[a.length - 1]
        : g.call(a, Math.max(a.length - b, 0));
    }),
  ...
  (n.flatten = function (a, b) {
    ...
    (n.zip = function (a) {
      if (null == a) return [];
      for (
        var b = n.max(arguments, "length").length, c = Array(b), d = 0;
        b > d;
        d++
      )
  ...
  var t = function (a, b, c, d) {
    ...
    if (
      ...
      "constructor" in a &&
      "constructor" in b &&
      !(n.isFunction(g) && g instanceof g && n.isFunction(h) && h instanceof h)
    )
      return !1;
    c.push(a), d.push(b);
    var j, k;
  ...
  (this.FirechatDefaultTemplates["templates/layout-full.html"] = function (
    obj
  ) {
    obj || (obj = {});
    var __t,
  ...
  (this.FirechatDefaultTemplates["templates/layout-popout.html"] = function (
    obj
  ) {
    obj || (obj = {});
    var __t,
  ...
  (this.FirechatDefaultTemplates[
    ...
    with (obj)
      (__p +=
        "<div data-toggle='firechat-contextmenu' class='contextmenu' data-message-id='" +
        __e(id) +
  ...
  (this.FirechatDefaultTemplates["templates/message.html"] = function (obj) {
    ...
    with (obj)
      (__p += "<div class='message message-" + __e(type) + " "),
        isSelfMessage && (__p += " message-self "),
        (__p +=
          "' data-message-id='" +
          __e(id) +
          "' data-user-id='" +
          ...
          "' data-user-name='" +
          __e(name) +
          "' data-class=\"firechat-message\">\n<div class='clearfix'>\n<label class='fourfifth'>\n<strong class='name' title='" +
          __e(name) +
          "'>" +
          __e(name) +
          "</strong>\n<em>(" +
  ...
  (this.FirechatDefaultTemplates["templates/prompt-alert.html"] = function (
    obj
  ) {
    obj || (obj = {});
    var __t,
  ...
  (this.FirechatDefaultTemplates[
    ...
    with (obj)
      __p +=
        "<div class='clearfix'>\n<h6>Give your chat room a name:</h6>\n<input data-input='firechat-room-name' type='text' placeholder='Room name...' style='margin-bottom: 5px;' maxlength='" +
        __e(maxLengthRoomName) +
        "'>\n</div>";
    return __p;
  }),
  (this.FirechatDefaultTemplates[
  ...
  (this.FirechatDefaultTemplates["templates/prompt-user-mute.html"] = function (
    obj
  ) {
    obj || (obj = {});
    var __t,
  ...
  (this.FirechatDefaultTemplates["templates/room-list-item.html"] = function (
    obj
  ) {
    function print() {
      __p += __j.call(arguments, "");
  ...
  (this.FirechatDefaultTemplates[
    ...
    with (obj)
      (__p +=
        ...
        "' data-user-name='" +
        __e(name) +
        "'>\n<a href='#!' class='clearfix'>\n<span class='left twothird clipped' title='" +
        __e(name) +
        "'>" +
        __e(name) +
        "</span>"),
  ...
  (this.FirechatDefaultTemplates[
    ...
    with (obj)
      (__p +=
        ...
        "'>\n<a href='#!' class='clearfix'>\n"),
        (__p += disableActions
          ? "\n<span class='left fourfifth clipped' title='" +
            __e(name) +
            "'>" +
            __e(name) +
            "</span>\n"
          : "\n<span data-event='firechat-user-invite' class='left fourfifth clipped' title='" +
            __e(name) +
            "'>" +
            __e(name) +
  ...
  (this.FirechatDefaultTemplates["templates/tab-content.html"] = function (
    obj
  ) {
    obj || (obj = {});
    var __t,
    ...
    with (obj)
      __p +=
        ...
        "' data-room-id='" +
        __e(id) +
        "' class='tab-pane'>\n<div class='tab-pane-menu clearfix'><div class='firechat-dropdown twofifth'>\n<a data-event='firechat-user-room-list-btn' class='full btn firechat-dropdown-toggle' data-toggle=\"firechat-dropdown\" href='#' data-target='firechat-room-user-list-" +
        __e(id) +
        "'>\n<span class='icon user-group'></span>\nIn Room\n<span class='caret'></span>\n</a>\n<div class='firechat-dropdown-menu' role='menu'>\n<ul id='firechat-room-user-list-" +
        __e(id) +
        "' class='full'></ul>\n</div>\n</div><div class='firechat-dropdown twofifth'>\n<a data-event='firechat-user-search-btn' class='full btn firechat-dropdown-toggle' data-toggle=\"firechat-dropdown\" href='#'>\n<span class='icon plus'>+</span>\nInvite\n<span class='caret'></span>\n</a><div class='firechat-dropdown-menu' role='menu'>\n<div class='firechat-dropdown-header aligncenter clearfix'>\n<div class='search-wrapper'>\n<span class='icon search'></span>\n<input type='text' data-event='firechat-user-search' data-template='templates/room-user-search-list-item.html' data-target='firechat-room-user-search-" +
        __e(id) +
        "' data-controls='firechat-room-user-search-controls-" +
        __e(id) +
        "' class='center fivesixth'>\n</div>\n</div>\n<ul id='firechat-room-user-search-" +
        __e(id) +
        "'></ul><div class='firechat-dropdown-footer aligncenter clearfix'>\n<div id='firechat-room-user-search-controls-" +
        __e(id) +
        "' class='clearfix'><span class=\"quarter\"></span>\n<!--\n<button type='button' class='btn third disabled' data-event='firechat-user-search' data-template='templates/room-user-search-list-item.html' data-target='firechat-room-user-search-" +
        __e(id) +
        "' data-controls='firechat-room-user-search-controls-" +
        __e(id) +
        "' data-toggle='firechat-pagination-prev' disabled=disabled>Prev</button>\n-->\n<button type='button' class='btn half disabled' data-event='firechat-user-search' data-template='templates/room-user-search-list-item.html' data-target='firechat-room-user-search-" +
        __e(id) +
        "' data-controls='firechat-room-user-search-controls-" +
        __e(id) +
        "' data-toggle='firechat-pagination-next'  disabled=disabled>Next</button>\n</div>\n</div>\n</div>\n</div><a href='#!' data-event='firechat-close-tab' class='icon close right' style='15px 5px' title='Leave Room'></a></div><div class='clearfix'>\n<div id='firechat-messages" +
        __e(id) +
  ...
  (this.FirechatDefaultTemplates["templates/tab-menu-item.html"] = function (
    obj
  ) {
    obj || (obj = {});
    var __t,
    ...
    with (obj)
      __p +=
        ...
        "'>\n<a href='#" +
        __e(id) +
        "' data-toggle='firechat-tab' title='" +
        __e(name) +
        "'>" +
        __e(name) +
        "</a>\n</li>";
  ...
  (this.FirechatDefaultTemplates[
    ...
    with (obj)
      (__p +=
        ...
        "'>\n<a href='#!' class='clearfix'>\n"),
        (__p += disableActions
          ? "\n<span class='left fivesixth clipped' title='" +
            __e(name) +
            "'>" +
            __e(name) +
            "</span>\n"
          : "\n<span data-event='firechat-user-chat' class='left fivesixth clipped' title='" +
            __e(name) +
            "'>" +
            __e(name) +
            "</span>\n<span data-event='firechat-user-chat' class='icon user-chat right' title='Invite to Private Chat'>&nbsp;</span>\n"),
  ...
  (function () {
    function a(a, b) {
      (this._firechatRef = a),
        (this._firebaseApp = a.database.app),
        (this._user = null),
        (this._userId = null),
        (this._userName = null),
        (this._isModerator = !1),
        ...
        (this._privateRoomRef = this._firechatRef.child(
    ...
    (a.noConflict = function () {
      ...
      (a.prototype = {
        _loadUserMetadata: function (a) {
          var c = this;
          this._userRef.transaction(
            function (a) {
              if (!a || !a.id || !a.name)
                return { id: c._userId, name: c._userName };
            },
            function (d, e, f) {
              (c._user = f.val()),
                c._moderatorsRef.child(c._userId).once("value", function (d) {
        ...
        _setupDataEvents: function () {
          ...
          a.on(
            ...
            this._queuePresenceOperation(this._sessionRef, !0, null);
          var b = this._usersOnlineRef.child(this._userName.toLowerCase()),
            c = b.child(this._sessionId);
          this._queuePresenceOperation(
            c,
            { id: this._userId, name: this._userName },
            null
          ),
            this._userRef.on("value", this._onUpdateUser, this),
            this._userRef
              .child("invites")
              .on("child_added", this._onFirechatInvite, this),
            this._userRef
              .child("notifications")
              .on("child_added", this._onNotification, this);
        },
        ...
        _queuePresenceOperation: function (a, b, c) {
          a.onDisconnect().set(c),
            a.set(b),
            (this._presenceBits[a.toString()] = {
              ref: a,
              onlineValue: b,
              offlineValue: c,
            });
        ...
        _onNotification: function (a) {
          var b = a.val();
          b.read ||
            (("suspension" !== b.notificationType ||
              b.data.suspendedUntil < new Date().getTime()) &&
              a.ref.child("read").set(!0),
            this._invokeEventCallbacks("notification", b));
        },
        _onFirechatInvite: function (a) {
          ...
          c.status ||
            ((c.id = c.id || a.key),
            b.getRoom(c.roomId, function (a) {
              (c.toRoomName = a.name),
                b._invokeEventCallbacks("room-invite", c);
            }));
        },
        _onFirechatInviteResponse: function (a) {
          var b = a.val();
          (b.id = b.id || a.key),
            this._invokeEventCallbacks("room-invite-response", b);
        },
      }),
      (a.prototype.setUser = function (a, c, d) {
        ...
        e._firebaseApp.auth().onAuthStateChanged(function (f) {
          f
            ? ((e._userId = a.toString()),
              (e._userName = c.toString()),
              (e._userRef = e._firechatRef.child("users").child(e._userId)),
              (e._sessionRef = e._userRef.child("sessions").push()),
              (e._sessionId = e._sessionRef.key),
              e._loadUserMetadata(function () {
                b.setTimeout(function () {
                  d(e._user), e._setupDataEvents();
                }, 0);
              }))
            : e.warn(
                "Firechat requires an authenticated Firebase reference. Pass an authenticated reference before loading."
              );
        });
      }),
      (a.prototype.resumeSession = function () {
        this._userRef.child("rooms").once(
          "value",
          function (a) {
            var b = a.val();
      ...
      (a.prototype.createRoom = function (a, b, c) {
        ...
        "private" === b &&
          ((f.authorizedUsers = {}), (f.authorizedUsers[this._userId] = !0)),
          e.set(f, function (a) {
          ...
          if (a && d && !b._rooms[a]) {
            if (((b._rooms[a] = !0), b._user)) {
              b._userRef
                .child("rooms")
                .child(a)
                .set({ id: a, name: d, active: !0 });
              var e = b._firechatRef
                .child("room-users")
                .child(a)
                .child(b._userId)
                .child(b._sessionId);
              b._queuePresenceOperation(
                e,
                { id: b._userId, name: b._userName },
                null
              );
            }
            b._onEnterRoom({ id: a, name: d }),
              b._roomRef.child(a).once(
                "value",
                function (c) {
                  b._messageRef
                    .child(a)
                    .limitToLast(b._options.numMaxMessages)
                    .on(
                      "child_added",
                      function (c) {
                        b._onNewMessage(a, c);
      ...
      (a.prototype.leaveRoom = function (a) {
        ...
        if ((b._messageRef.child(a).off(), b._user)) {
          ...
          b._removePresenceOperation(d, null),
            b._userRef.child("rooms").child(a).remove();
        }
      ...
      (a.prototype.sendMessage = function (a, b, c, d) {
        ...
        return f._user
          ? ((e = f._messageRef.child(a).push()),
            void e.setWithPriority(
              g,
              firebase.database.ServerValue.TIMESTAMP,
              d
            ))
          : (f._onAuthRequired(),
            void (d && d(new Error("Not authenticated or user not set!"))));
      }),
      ...
      (a.prototype.toggleUserMute = function (a, b) {
        ...
        return c._user
          ...
          : (c._onAuthRequired(),
            void (b && b(new Error("Not authenticated or user not set!"))));
      }),
      ...
      (a.prototype.suspendUser = function (a, b, c) {
        ...
        d._suspensionsRef.child(a).set(e, function (b) {
          return b && c
            ? c(b)
            : (d.sendSuperuserNotification(a, "suspension", {
                suspendedUntil: e,
              }),
              c(null));
        });
        ...
        c._userRef
          ...
          .once(
            ...
            function (d) {
              var e = d.val();
              return null === e && b
                ? b(new Error("acceptInvite(" + a + "): invalid invite id"))
                : (c.enterRoom(e.roomId),
                  void c._userRef
                    .child("invites")
                    .child(a)
                    .update(
                      { status: "accepted", toUserName: c._userName },
                      b
                    ));
            },
            c
      ...
      (a.prototype.declineInvite = function (a, b) {
        var c = this,
          d = { status: "declined", toUserName: c._userName };
      ...
      (a.prototype.getUsersByPrefix = function (a, c, d, e, f) {
        ...
        (g = c
          ...
          ? g.startAt(null, h)
          : g.startAt()),
          (g = e ? g.limitToLast(e) : g),
          g.once("value", function (c) {
            var d = c.val() || {},
              e = {};
            for (var g in d) {
              var i,
              ...
              (a.length > 0 && 0 !== i.toLowerCase().indexOf(h)) ||
                (e[i] = { name: i, id: j });
            }
            b.setTimeout(function () {
              f(e);
      ...
      (a.prototype.warn = function (a) {
        console &&
          ((a = "Firechat Warning: " + a),
          "function" == typeof console.warn
            ? console.warn(a)
            : "function" == typeof console.log && console.log(a));
      });
  })(),
  (function (a) {
    function b(b, c, d) {
      ...
      (d = d || {}),
        ...
        this._renderLayout(),
        (this.$wrapper = a("#firechat")),
        (this.$roomList = a("#firechat-room-list")),
        (this.$tabList = a("#firechat-tab-list")),
        (this.$tabContent = a("#firechat-tab-content")),
        (this.$messages = {}),
        (this.$rateLimit = {
          limitCount: 10,
          limitInterval: 1e4,
    ...
    if (!a || parseInt(a().jquery.replace(/\./g, ""), 10) < 170)
      throw new Error("jQuery 1.7 or later required!");
    var c = this,
      d = c.FirechatUI;
    if (((c.FirechatUI = b), !self.FirechatDefaultTemplates))
    ...
    (b.noConflict = function () {
      ...
      (b.prototype = {
        ...
        _onLeaveRoom: function (a) {
          this.removeTab(a),
            this._roomQueue.length > 0 &&
              this._chat.enterRoom(this._roomQueue.shift(a));
        },
        _onNewMessage: function (a, b) {
          var c = b.userId;
          (this._user && this._user.muted && this._user.muted[c]) ||
            this.showMessage(a, b);
        },
        _onRemoveMessage: function (a, b) {
        ...
        _onChatInviteResponse: function (a) {
          if (a.status) {
            var b,
              c = this,
              d =
                FirechatDefaultTemplates["templates/prompt-invite-reply.html"];
            a.status && "accepted" === a.status
              ? ((b = this.prompt("Accepted", d(a))),
                this._chat.getRoom(a.roomId, function (b) {
                  c.attachTab(a.roomId, b.name);
                }))
              : (b = this.prompt("Declined", d(a))),
        ...
        _onNotification: function (a) {
          if ("warning" === a.notificationType)
            this.renderAlertPrompt(
              "Warning",
              "You are being warned for inappropriate messaging. Further violation may result in temporary or permanent ban of service."
            );
            ...
            if (c > 0) {
              ...
              (d += Math.floor(c / 60) + " minutes"),
                this.renderAlertPrompt(
                  "Suspended",
                  "A moderator has suspended you for violating site rules. You cannot send messages for another " +
                    d +
                    "."
                );
            }
      ...
      (b.prototype.setUser = function (a, b) {
        ...
        c._chat.setUser(a, b, function (a) {
          (c._user = a),
            c._chat.userIsModerator() && c._bindSuperuserUIEvents(),
            c._chat.resumeSession();
        });
      }),
        ...
        var b = this,
          c = function (b) {
            var c = a(this),
              ...
              e = a('[data-message-id="' + d + '"]')
                .closest("[data-user-id]")
                .data("user-id"),
              f = a('[data-message-id="' + d + '"]')
                .closest("[data-room-id]")
                .data("room-id");
            return { messageId: d, userId: e, roomId: f };
          },
          d = function () {
          ...
          e = function (e) {
            var f,
              ...
              i =
                FirechatDefaultTemplates["templates/message-context-menu.html"],
              j = c.call(this, e);
            e.preventDefault(),
              d(),
              g.addClass("highlighted"),
              b._chat.getRoom(j.roomId, function (c) {
                (f = a(i({ id: h.data("message-id") }))),
                  f
                    .css({ left: e.clientX, top: e.clientY })
                    .appendTo(b.$wrapper);
              });
          };
        a(document).bind("click", { self: this }, function (a) {
          ...
          a(document).delegate(
            '[data-event="firechat-user-suspend-hour"]',
            "click",
            function (a) {
              var d = c.call(this, a);
          ...
          a(document).delegate(
            '[data-event="firechat-user-suspend-day"]',
            "click",
            function (a) {
              var d = c.call(this, a);
          ...
          a(document).delegate(
            '[data-event="firechat-message-delete"]',
            "click",
            function (a) {
              var d = c.call(this, a);
      ...
      (b.prototype._bindForRoomList = function () {
        ...
        a("#firechat-btn-rooms").bind("click", function () {
          if (!a(this).parent().hasClass("open")) {
            var c =
                (a(this),
                FirechatDefaultTemplates["templates/room-list-item.html"]),
              d = function () {
                var c = a(this).parent(),
                  d = c.data("room-id"),
                  e = c.data("room-name");
                return (
                  b.$messages[d] ? b.focusTab(d) : b._chat.enterRoom(d, e), !1
                );
              };
            b._chat.getRoomList(function (e) {
              ...
              for (var f in e) {
                ...
                if ("public" == g.type) {
                  ...
                  var h = a(c(g));
                  h.children("a").bind("click", d),
                    b.$roomList.append(h.toggle(!0));
                }
              }
            });
          }
      ...
      (b.prototype._bindForUserRoomList = function () {
        var b = this;
        a(document).delegate(
          '[data-event="firechat-user-room-list-btn"]',
          "click",
          function (c) {
            c.stopPropagation();
            var d = a(this),
              ...
              f =
                FirechatDefaultTemplates["templates/room-user-list-item.html"],
              g = d.data("target"),
              h = a("#" + g);
            h.empty(),
              b._chat.getUsersByRoom(e, function (c) {
                for (var d in c)
                  (user = c[d]),
                    (user.disableActions = !b._user || user.id === b._user.id),
                    (user.nameTrimmed = b.trimWithEllipsis(
                      user.name,
                      b.maxLengthUsernameDisplay
                    )),
                    (user.isMuted =
                      b._user && b._user.muted && b._user.muted[user.id]),
                    h.append(a(f(user)));
      ...
      (b.prototype._bindForUserSearch = function () {
        var b = this,
          ...
          d = function (c, d, e, f, g, h) {
            ...
            b._chat.getUsersByPrefix(f, g, h, b.maxUserSearchResults, function (
              a
            ) {
              var c,
                d,
              ...
              for (e in a) {
                var m = a[e];
                if (
                  ((m.disableActions = !b._user || m.id === b._user.id),
                  (l += 1),
                  i.append(k(m)),
                  1 === l)
                )
                  g = m.name.toLowerCase();
              ...
              j &&
                ((c = j.find('[data-toggle="firechat-pagination-prev"]')),
                (d = j.find('[data-toggle="firechat-pagination-next"]')),
                h
                  ? d
        ...
        a(document).delegate('[data-event="firechat-user-search"]', "keyup", c),
          a(document).delegate(
            '[data-event="firechat-user-search"]',
            "click",
            c
          ...
          a(document).delegate(
            '[data-event="firechat-user-search-btn"]',
            "click",
            function (b) {
              b.stopPropagation();
      ...
      (b.prototype._bindForUserMuting = function () {
        var b = this;
        a(document).delegate(
          '[data-event="firechat-user-mute-toggle"]',
          "click",
          function (c) {
            var d = a(this),
            ...
            if ((c.preventDefault(), g)) b._chat.toggleUserMute(e);
              ...
              var i = b.prompt("Mute User?", h({ userName: f }));
              i
                .find("a.close")
                .first()
                .click(function () {
                ...
                i
                  .find("[data-toggle=decline]")
                  .first()
                  .click(function () {
                    return i.remove(), !1;
                  }),
                i
                  .find("[data-toggle=accept]")
                  .first()
                  .click(function () {
      ...
      (b.prototype._bindForChatInvites = function () {
        var b = this,
          c = function (c) {
            var d,
              ...
              i =
                FirechatDefaultTemplates[
                  "templates/prompt-invite-private.html"
                ];
            return (
              b._chat.getRoom(g, function (a) {
                return (
                  (d = b.prompt(
                    "Invite",
                    i({ userName: h, roomName: a.name })
                  )),
                  d.find("a.close").click(function () {
                    return d.remove(), !1;
                  }),
          ...
          d = function (c) {
            ...
            return (
              f &&
                ...
                ((d = b.prompt(
                  "Private Invite",
                  h({ userName: g, roomName: "Private Chat" })
                )),
                d.find("a.close").click(function () {
                  return d.remove(), !1;
                }),
                ...
                d
                  ...
                  .click(function () {
                    ...
                    var a = "Private Chat";
                    return (
                      b._chat.createRoom(a, "private", function (c) {
        ...
        a(document).delegate('[data-event="firechat-user-chat"]', "click", d),
          a(document).delegate(
            '[data-event="firechat-user-invite"]',
            "click",
            c
          );
      }),
      (b.prototype._bindForRoomListing = function () {
        ...
        c.bind("click", function (a) {
          ...
          d.bind("click", function (c) {
            ...
            return (
              a("#firechat-prompt-create-room").remove(),
              b._chat.createRoom(d),
              !1
            );
          });
      }),
      (b.prototype._setupTabs = function () {
        var b = function (b) {
            ...
            h ||
              ((h = f.attr("href")),
              (h = h && h.replace(/.*(?=#[^\s]*$)/, ""))),
              f.parent("li").hasClass("active") ||
                ((e = a.Event("show", { relatedTarget: i })),
                f.trigger(e),
                e.isDefaultPrevented() ||
                  ((d = a(h)),
                  c(f.parent("li"), g),
                  c(d, d.parent(), function () {
                    f.trigger({ type: "shown", relatedTarget: i });
                  })));
          },
          c = function (b, c, d) {
            function e() {
              f
                ...
                .removeClass("active"),
                b.addClass("active"),
                g ? b.addClass("in") : b.removeClass("fade"),
                b.parent(".firechat-dropdown-menu") &&
                  b.closest("li.firechat-dropdown").addClass("active"),
                d && d();
            }
            var f = c.find("> .active"),
        ...
        a(document).delegate('[data-toggle="firechat-tab"]', "click", function (
          c
        ) {
      ...
      (b.prototype._setupDropdowns = function () {
        var b = function (b) {
            ...
            if (!e.is(".disabled, :disabled"))
              return c(), g || f.toggleClass("open"), e.focus(), !1;
          },
          c = function () {
        ...
        a(document)
          .bind("click", c)
          .delegate(".firechat-dropdown-menu", "click", function (a) {
            a.stopPropagation();
          })
      ...
      (b.prototype._bindTextInputFieldLimits = function () {
        a("body").delegate(
          'input[data-provide="limit"], textarea[data-provide="limit"]',
          "keyup",
          function (b) {
            var c = a(this),
              d = a(c.data("counter")),
      ...
      (b.prototype.toggleInputs = function (b) {
        a("#firechat-tab-content textarea").each(function () {
          ...
          b
            ? a(this).val("")
            : a(this).val(
                "You have exceeded the message limit, please wait before sending."
              ),
            c.prop("disabled", !b);
        }),
      ...
      (b.prototype.attachTab = function (b, c) {
        ...
        i.bind("keydown", function (a) {
          ...
          if (13 === a.which && "" !== c)
            return i.val(""), d._chat.sendMessage(b, c), !1;
        });
        var j = FirechatDefaultTemplates["templates/tab-menu-item.html"],
          k = a(j(e));
        this.$tabList.prepend(k),
          k.bind("shown", function (a) {
            h.scrollTop(h[0].scrollHeight);
          });
        var l = this.$tabList.children("li"),
          m = Math.floor(a("#firechat-tab-list").width() / l.length);
        this.$tabList.children("li").css("width", m),
          this.$roomList
            .children("[data-room-id=" + b + "]")
            .children("a")
            .addClass("highlight"),
          a("#firechat-btn-room-user-list-" + b).bind("click", function () {
            return (
              d.sortListLexicographically("#firechat-room-user-list-" + b), !1
            );
          }),
          this.focusTab(b);
      }),
      ...
      (b.prototype.removeTab = function (b) {
        delete this.$messages[b],
          this.$tabContent.find("[data-room-id=" + b + "]").remove(),
          this.$tabList.find("[data-room-id=" + b + "]").remove();
        var c = this.$tabList.children("li"),
          d = Math.floor(a("#firechat-tab-list").width() / c.length);
        this.$tabList.children("li").css("width", d),
          this.$tabList
            .find('[data-toggle="firechat-tab"]')
            .first()
            .trigger("click"),
          this.$roomList
            .children("[data-room-id=" + b + "]")
      ...
      (b.prototype.showMessage = function (b, c) {
        ...
        (e.message = _.map(e.message.split(" "), function (a) {
          return d.urlPattern.test(a) || d.pseudoUrlPattern.test(a)
            ? d.linkify(encodeURI(a))
            : _.escape(a);
        }).join(" ")),
          (e.message = d.trimWithEllipsis(e.message, d.maxLengthMessage));
        var f = FirechatDefaultTemplates["templates/message.html"],
          g = a(f(e)),
          h = d.$messages[b];
        if (h) {
          var i = !1;
          h.scrollTop() / (h[0].scrollHeight - h[0].offsetHeight) >= 0.95
            ? (i = !0)
            : h[0].scrollHeight <= h.height() && (i = !0),
            h.append(g),
            i && h.scrollTop(h[0].scrollHeight);
        }
      }),
      ...
      (b.prototype.promptCreateRoom = function () {
        ...
        c
          ...
          c
            .find("[data-toggle=submit]")
            .first()
            .click(function () {
              var b = c.find("[data-input=firechat-room-name]").first().val();
              return (
                "" !== b && (a._chat.createRoom(b, "public"), c.remove()), !1
              );
            }),
          c.find("[data-input=firechat-room-name]").first().focus(),
          c
            .find("[data-input=firechat-room-name]")
            .first()
            .bind("keydown", function (b) {
              if (13 === b.which) {
                var d = c.find("[data-input=firechat-room-name]").first().val();
                if ("" !== d)
                  return a._chat.createRoom(d, "public"), c.remove(), !1;
              }
            });
      }),
      (b.prototype.prompt = function (b, c) {
        var d,
          e = FirechatDefaultTemplates["templates/prompt.html"];
        return (
          (d = a(e({ title: b, content: c })).css({
          ...
          this.$wrapper.append(d.removeClass("hidden")),
          d
        );
      }),
      (b.prototype.linkify = function (a) {
        var b = this;
        return a
          .replace(b.urlPattern, '<a target="_blank" href="$&">$&</a>')
          .replace(
            b.pseudoUrlPattern,
